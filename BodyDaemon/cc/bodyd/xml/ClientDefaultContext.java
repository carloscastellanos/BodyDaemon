...
public class ClientDefaultContext extends AbstractClientContext
{
	//private Attributes atts = null;
	private ClientMessageFormatter formatter = null;
	
	protected ClientDefaultContext()
	{
		
	}
	
	public ClientDefaultContext(ClientMessageFormatter clientFormatter,
